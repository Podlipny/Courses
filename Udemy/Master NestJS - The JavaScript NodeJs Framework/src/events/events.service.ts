...
export class EventsService {
  ...
  public getEventsWithAttendeeCountQuery(): SelectQueryBuilder<Event> {
    return this.getEventsBaseQuery()
      // do virtualni property attendeeCount ulozi count of attendees
      .loadRelationCountAndMap(
        'e.attendeeCount', 'e.attendees'
      )
      // vybereme jen attendee ktery acceptovali pozvanku a ulozime ulozi count of attendees
      .loadRelationCountAndMap(
        'e.attendeeAccepted', // property modelu do ktere nacitame vysledek
        'e.attendees', // entita
        'attendee', // alias pro dalsi querybuilder - ctvrty argument a to funkce nize
        (qb) => qb
          .where(
